	...
	*/
	...
	{	
		for (int i = 0; i < (ResourceGenerator.InstanceResourceGenerator.basicEconomyValues.Length; i++) 
		{
			...
			{	
				CopyBasicValues (i, (ResourceGenerator.InstanceResourceGenerator.basicEconomyValues [i]);
				break;
			}							
		}
	}
	...
	{		
		...
		(ResourceGenerator.InstanceResourceGenerator.existingEconomyBuildings.Add (myEconomyParams);
	}
	*/
